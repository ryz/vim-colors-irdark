" ir_dark color scheme by ryz
" based on ir_black by Infinite Red
...
" General colors
hi Normal           guifg=#f6f3e8     guibg=gray9       gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=NONE
hi NonText          guifg=#070707     guibg=gray9       gui=NONE      ctermfg=black       ctermbg=NONE        cterm=NONE

hi Cursor           guifg=black       guibg=white       gui=NONE      ctermfg=black       ctermbg=white       cterm=reverse
hi LineNr           guifg=#3D3D3D     guibg=gray9       gui=NONE      ctermfg=darkgray    ctermbg=NONE        cterm=NONE
...
if version >= 700 " Vim 7.x specific colors
  ...
  hi ColorColumn    guifg=NONE        guibg=gray6       gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=BOLD
...
if has('gui_running') || &t_Co > 2
    ...
    if hlexists('MyTagListFileName')
        ...
        highlight default TagListFileName guibg=gray9 ctermbg=darkgrey
                    \ guifg=#6699CC ctermfg=white
    endif
